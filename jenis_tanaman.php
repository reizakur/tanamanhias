...
">
              <div class="portfolio-info">
                <h3><a href="detail.php?id_tanaman=<?php echo $row['id_tanaman']?>"><?php echo $row['judul']?></a></h3>
                <div>
                  <a href="detail.php?id_tanaman=<?php echo $row['id_tanaman']?>" title="<?php echo $row['judul']?>"></a>
                </div>
              </div>
            </div>
          </div>
