...
">
 ...
 <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="nama_tanaman" placeholder="Password">
    </div>
  </div>
   ...
   <div class="form-group row">
    ...
    <div class="col-md-12">
                        <div class="card card-plain">
                            <div class="header">
                                <h4 class="title">Data tanaman :</h4>
                            </div>
...
if(isset($_POST['qcari'])){
  $qcari = $_POST['qcari'];
$sql=mysqli_query($con,"SELECT * FROM tanaman where id_tanaman like 
...
while ($row= mysqli_fetch_array($sql)){
  ...
  echo"<tr>";?>
                        ...
                        <td><img src="../images/<?php echo $row['gambar'];?>" style="
    width: 100px;
    height: 100px;
"></td>                 <td><?php echo $row['nama_tanaman'] ?></td>
                        <td><?php echo $row['coach'] ?></td>

                        <td><?php echo $row['stadion'] ?></td>
                                        <td>        <a href='eksekusi_hapus_tambahbrand.php?id_tanaman=<?php echo $row['id_tanaman']?>' class='btn btn-danger'><span class='fa fa-trash fa-1x'></span> 
                                       <td>    <a href='edit-barang.php?id_tanaman=<?php echo $row['id_tanaman']?>'class="btn btn-success"><span class="fa fa-edit fa-1x"></a>      
                                               <?php }?> 
                                                  </a></td>
                                        </td>
                                        </tr>
            ...
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script> <a href="http://www.instagram/reizakur">MR.RAtanaman</a>, Website Toko Online
                </p>
            </div>
        </footer>
